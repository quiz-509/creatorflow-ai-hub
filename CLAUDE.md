...
Ce workspace est le Risemind AI personnel de Joacenel. Il a été créé avec le Risemind AI Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Joacenel, originaire d'Haïti et installé à Montréal depuis 2017. Je suis entrepreneur et créateur de contenu digital, actif sur YouTube, TikTok, Facebook et Instagram autour de l'intelligence artificielle, du développement personnel, du trading et du divertissement, à destination d'un public francophone et créolophone.

Mes objectifs prioritaires actuels sont de publier régulièrement (3 à 5 contenus par semaine), d'atteindre les conditions de monétisation YouTube et de monter en niveau sur le montage, le branding et la stratégie digitale.

À long terme, je veux vivre de revenus en ligne diversifiés, bâtir une communauté engagée et lancer ma propre structure ou agence digitale autour de l'IA.

Le domaine où j'ai besoin du plus d'aide en ce moment : la productivité, l'organisation et la discipline personnelle pour éviter la procrastination et rester régulier sur mes projets.
...
| `.claude/commands/` | Commandes personnalisées de mon Risemind AI |
| `.claude/skills/` | Skills (super-pouvoirs) de mon Risemind AI |
